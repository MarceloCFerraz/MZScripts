from utils.common import cprint, printLine
...
def channelsDict(sheet):
    ...
    for row_index in range(2, sheet.max_row):
        ...
        if channel_name is not None and email is not None:
            ...
            if channel_name not in channels_list:
                ...
                channels_dict[channel_name] = emailsListFromChannelName(
                    sheet, channel_name, row_index
                )
